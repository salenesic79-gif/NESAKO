...
def chat_form():
    ...
    <html>
        ...
        <body style="font-family:sans-serif;padding:20px;">
            ...
            <form method="post">
                <input type="text" name="pitanje" id="pitanje" placeholder="Unesi poruku" style="width:100%;padding:10px;font-size:18px;" autofocus required/>
                <br><br>
...
async def handle_chat(pitanje: str = Form(...)):
    try:
