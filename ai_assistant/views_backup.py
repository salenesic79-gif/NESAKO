    ...
    def post(self, request):
        ...
        try:
            ...
            try:
                ...
                sports_keywords = [# --- Sports router: SofaScore as primary (fixtures), Fudbal91 as optional odds enrichment ---
sports_keywords = [
...
for alias, canonical in alias_map.items():
    if alias in normalized_query:
        normalized_query = normalized_query.replace(alias, canonical)                    'kvote', 'koeficij', 'fudbal', 'utakmic', 'premier league', 'epl', 'la liga', 'laliga',
...
if not sofa or not sofa.get('events'):
    try:
        ...
        # Ako fallback ne radi, vrati prazno
        sofa = {'events': []}
# === KRAJ FALLBACK ===
                        else:
                            sofa = sofascore.fetch_quick(hours=hours_val, keys=['epl','laliga','bundesliga','seriea','ligue1','ucl','serbia'], debug=False)
